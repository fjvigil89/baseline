...
nfold = 5
while nfold > 1:      
      X_train, y_train = split_data("data/csv/train_a_n_both_meta_data_fold"+str(nfold)+".csv")
      X_test, y_test = split_data("data/csv/test_a_n_both_meta_data_fold"+str(nfold)+".csv")
