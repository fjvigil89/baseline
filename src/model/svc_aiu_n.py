...
nfold = 5
while nfold > 1:      
      X_train, y_train = split_data("data/csv/train_aiu_n_both_meta_data_fold"+str(nfold)+".csv")
      X_test, y_test = split_data("data/csv/test_aiu_n_both_meta_data_fold"+str(nfold)+".csv")
      ...
      for c in length:            
            for deg in range(1,5):                  
                ...
                data_processing['list'].append("aiu_n_fold"+str(nfold)+"")
      ...
      df.to_excel('data/xls/svm_aiu_n.xlsx', sheet_name='svc_aiu_n', index=False)
      nfold -= 1 
